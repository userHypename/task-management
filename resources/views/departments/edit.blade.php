...
@section('content')
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white">Edit Department</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">Update department information</p>
    </div>
