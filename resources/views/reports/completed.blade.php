...
@section('title', 'Completed Tasks Report')

@section('content')
    <div class="mb-6">
        <h1 class="page-title">Completed Tasks</h1>
        <p class="text-gray-600 mt-2">Tasks marked as completed</p>
    </div>
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">No completed tasks found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
